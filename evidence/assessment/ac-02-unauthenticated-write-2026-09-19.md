...
Scope: project-owned Docker lab. Source role: ephemeral `modbus-pump-check` assessment container attached to the Compose `control` network. Target: `openplc:5020`, Unit ID 1. The assessment container had no FUXA session or PLC credential. Raw console evidence: [`ac-02-write-test-2026-09-19.txt`](ac-02-write-test-2026-09-19.txt), SHA-256 `84BE4BD46A68887B9145ACABAB39D1119A52FF206300EEDFBC3F9477F3831017`.
