...
**현재 성과를 취약점 발견이나 조치 성공으로 주장하지 않습니다.** Modbus 읽기·쓰기, 짧은 공정 상태 변화, FUXA의 태그 값과 수동 운전 화면 반응, 정지 및 운전 중 패킷을 확인했습니다. 보안 통제는 아직 검증하지 않았습니다.
...
재시작 후 복원을 baseline으로 확보하고, 이후 접근 경계 평가·개선·재검증을 진행합니다.
